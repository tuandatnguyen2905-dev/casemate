...
const COMPANY_MATCHERS: Array<[ProgramIndustryId, string[]]> = [
  ...
  ['banking', ['techcombank', 'vpbank', 'uob vietnam', 'hsbc', 'msb', 'acb', 'home credit', 'national australia bank', 'nab bank', 'nab vietnam', 'nab']],
  ['insurance', ['manulife', 'prudential']],
  ['tech', ['shopee', 'seamoney', 'monee', 'tiktok', 'garena', 'vng', 'zalo', 'spx', 'viettel group', 'viettel telecom', 'viettel', 'pmax', 'momo']],
  ['consulting', ['deloitte', 'ey', 'dksh', 'turner & townsend']],
  ['logistics', ['expeditors', 'maersk']],
  ['industrial', ['bosch', 'hitachi energy', 'schneider electric', 'techtronic industries', 'panasonic', 'knauf', 'texas instruments', 'oppo', 'avery dennison', 'crystal international group', 'crystal international', 'crystal group']],
  ['healthcare', ['abbott']],
